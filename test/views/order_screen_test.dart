...
// Helper to wrap the whole app so provider is available on pushed routes too.
Widget _appWithProvider(Widget home, {Cart? cart}) {
...
void main() {
  group('OrderScreen - Initial State', () {
    testWidgets('displays the initial UI elements correctly',
      ...
      await tester.pumpWidget(_appWithProvider(orderScreen));
  ...
  group('OrderScreen - Interactions', () {
    ...
    testWidgets('quantity does not go below zero and buttons are disabled',
      ...
      // At zero quantity we expect two '0' texts: cart count and quantity display.
